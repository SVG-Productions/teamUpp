  ...
  return (
    <>
      ...
      <Draggable draggableId={column.id} index={index}>
        {(provided) => (
          <div
            className="relative flex flex-col bg-secondary rounded-md w-[228px]"
            ref={provided.innerRef}
            {...provided.draggableProps}
          >
            <div
              ref={editRef}
              className="sticky top-0 flex bg-secondary justify-start w-[228px] min-h-[44px] p-2.5 items-center"
            >
            ...
            <StrictModeDroppable droppableId={column.id} type="app">
              {(provided, snapshot) => (
                <div
                  ref={provided.innerRef}
                  className={`flex-grow min-h-[10px] p-2 rounded-md ${
