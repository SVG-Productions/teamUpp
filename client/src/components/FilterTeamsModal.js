...
const FilterTeamsModal = ({
  ...
  return (
    <div className="flex items-center justify-center min-h-screen fixed inset-0 z-50 overflow-y-auto sm:hidden">
      <div className="fixed inset-0 top-[124px] bg-white transition-opacity"></div>
