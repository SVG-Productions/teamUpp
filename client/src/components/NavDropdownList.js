...
const NavDropdownList = ({ setIsListShowing }) => {
  ...
  return (
    <div className="absolute flex flex-col top-1 -right-3 z-30">
      <div className="w-0 h-0 self-end mr-9 border-8 border-borderprimary border-t-0 border-l-transparent border-r-transparent" />
